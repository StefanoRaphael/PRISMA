...
// Cada retrato do lote recebe um ângulo/composição DIFERENTE, embaralhado a cada
// geração. Sem isso, as 4 chamadas usam o mesmo prompt e o modelo tende a repetir
// sempre o caminho mais óbvio: câmera na altura dos olhos, sujeito centralizado.
// Isso força variedade real dentro do mesmo lote, não só na sorte do modelo.
 ...
 */
export async function gerarRetratos(prompt, referencias, quantidade = 4, coresMarca = []) {
  ...
  const variantes = embaralhar(VARIANTES_ENQUADRAMENTO);
