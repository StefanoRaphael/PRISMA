...
// aquele pedido.
//
// A lista antiga mandava "right third of frame" e "generous negative space"
// em três das quatro entradas. Num quadro 9:16, que é estreito, terço lateral
// joga o sujeito quase na borda: era a origem da lateralização exagerada que
// o cliente relatou. Agora a reserva varia ÂNGULO e DISTÂNCIA, e mantém o
// sujeito perto do eixo central, porque é a escolha que nunca sai errada
// quando não houve raciocínio nenhum por trás.
const VARIANTES_ENQUADRAMENTO = [
  'SHOT VARIANT FOR THIS FRAME: slightly low camera angle (shooting up), subject near the vertical center axis of the frame, medium-close framing.',
  'SHOT VARIANT FOR THIS FRAME: slightly elevated camera angle (shooting down), subject near center with a small lateral offset, medium framing.',
  'SHOT VARIANT FOR THIS FRAME: eye-level camera, tighter crop, a foreground element partially entering one edge of the frame for depth.',
  'SHOT VARIANT FOR THIS FRAME: wider environmental composition, subject smaller within the setting, still close to the center axis, deep visible context around them.'
];
