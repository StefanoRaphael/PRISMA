 ...
 *
 * Devolve também o nome digitado no cadastro (guardado no metadata do
 * Supabase): é o que /api/me usa quando precisa criar o perfil que o gatilho
 * não criou, para a conta não nascer sem nome.
 * @returns {Promise<{id:string, email:string, nome:string}|null>}
 */
